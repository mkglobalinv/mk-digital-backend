        ...
        if (navigator.share) {
            try {
                await navigator.share({
                    title: `Join me on ${siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')}`,
                    ...
                    <div className="referral-modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="referral-modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            <div className="info-block intro-block">
                                <h4 style={{ color: '#E2E8F0', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}><Info size={18} color="#3B82F6" /> HOW TO EARN WITH {siteInfo?.branding?.siteName?.toUpperCase() || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'PREMIUM VTU')}</h4>
                                <p>There are two ways to earn through the {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')} Referral Program.</p>
                            </div>
                            ...
                            <div className="info-block premium-block" style={{ borderLeft: '4px solid #4ADE80' }}>
                                ...
                                <p>Invite friends, family, and customers to use {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')} for:</p>
                                ...
                                <div style={{ background: 'rgba(74, 222, 128, 0.1)', padding: '12px', borderRadius: '8px', marginTop: '8px', display: 'inline-block' }}>
                                    <strong style={{ fontSize: '1.2rem', color: '#4ADE80' }}>15% of {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')} Platform Profit</strong>
                                </div>
                            ...
                            <div className="info-block intro-block">
                                ...
                                <p>Your commissions do not stop after registration. As long as your referred retail customers continue using {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')}, you continue earning commissions from their eligible transactions. There is no limit to how many customers you can refer.</p>
                            </div>
                            ...
                            <div className="info-block warning-block" style={{ background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.3)' }}>
                                ...
                                <p style={{ marginBottom: '8px' }}>You earn 15% of {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')}'s platform profit on eligible retail transactions.</p>
                                <p style={{ fontSize: '0.85rem', opacity: 0.9 }}><strong>Example:</strong> If a customer buys ₦10,000 Data, your commission is NOT ₦1,500. Your commission is calculated from {siteInfo?.branding?.siteName || (window.location.host.includes('9jasub.com') ? '9JASUB' : 'Premium VTU')}'s profit on that transaction.</p>
                            </div>
