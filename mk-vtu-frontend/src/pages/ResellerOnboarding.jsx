    ...
    if (step === 100) return (
        <div className="onboarding-step success animate-scale-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            ...
            <div style={{ width: '100%', maxWidth: '400px', display: 'flex', flexDirection: 'column', gap: '12px', margin: '0 auto' }}>
                ...
                {/* Live website link */}
                <a
                    href={`https://${formData.domainOption === 'subdomain' ? `${formData.requestedDomain}.9jasub.com` : formData.requestedDomain}/`}
                    target="_blank"
                ...
                <p style={{ fontSize: '13px', color: '#64748b', margin: '4px 0 16px', lineHeight: '1.5' }}>
                    This is what your customers will see. Preview it anytime at <strong>{formData.domainOption === 'subdomain' ? `${formData.requestedDomain}.9jasub.com` : formData.requestedDomain}</strong>.
                </p>
