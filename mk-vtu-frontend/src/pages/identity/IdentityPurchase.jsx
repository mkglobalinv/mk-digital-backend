...
const normalizeIdentityResponse = (result, params = {}, serviceId = '') => {
  ...
  return {
    ...
    dateOfBirth: getFirstAvailableValue(idData, ['dateOfBirth', 'date_of_birth', 'dob', 'DOB', 'birthDate', 'birth_date', 'birthdate', 'DateOfBirth', 'Date of Birth', 'birthday']),
            ...
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <button type="button" onClick={() => {
                  ...
                  <Download size={18} /> View {((service.api_plan_id || '').toLowerCase().includes('bvn') || (service.name || '').toLowerCase().includes('bvn')) ? 'BVN' : 'NIN'} Slip
                </button>
              </div>
            </div>
          </div>
