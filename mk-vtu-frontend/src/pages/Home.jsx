      ...
      <div className="fintech-app-container" style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', padding: 0 }}>
        ...
        <div className="fintech-dashboard-grid" style={{ padding: '4px 12px 8px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="fintech-main-grid-col">
            ...
            {/* 1. Website Owner Promo (Horizontal) */}
            {!isWhiteLabelSite(siteInfo) && showResellerPromo && (
              <div className="fintech-promo-card animate-fade-in" onClick={() => navigate('/reseller/onboarding')} style={{ position: 'relative', overflow: 'hidden', padding: '12px 16px', background: 'linear-gradient(135deg, #0f172a, #1e1b4b)', color: 'white', cursor: 'pointer', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
                <div className="vip-banner-overlay" style={{ borderRadius: '12px' }}></div>
                
                {/* Left Side */}
                <div style={{ position: 'relative', zIndex: 1, flex: 1, paddingRight: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px' }}>
                    <div style={{ background: 'rgba(16, 185, 129, 0.15)', color: '#10b981', padding: '2px 6px', borderRadius: '4px', fontSize: '9px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '4px', border: '1px solid rgba(16,185,129,0.3)' }}>
                      <Zap size={10} /> WEBSITE OWNER
                    </div>
                  </div>
                  <h4 style={{ fontSize: '14px', fontWeight: '800', margin: '0 0 2px 0', lineHeight: '1.2', color: '#fff' }}>Create Website</h4>
                  <p style={{ fontSize: '11px', opacity: 0.7, margin: 0, lineHeight: '1.2' }}>Launch your branded VTU website in minutes.</p>
                </div>
                
                {/* Right Side */}
                <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ background: 'var(--primary)', color: 'white', padding: '6px 12px', borderRadius: '6px', fontSize: '11px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '4px' }}>
                    Launch My Website <ArrowRight size={12} />
                  </div>
                  <div 
                    onClick={(e) => { 
                      e.stopPropagation(); 
                    ...
                    style={{ color: 'rgba(255,255,255,0.5)', cursor: 'pointer', padding: '4px' }}
                  >
                    <XCircle size={16} />
                  </div>
                </div>
            ...
            {/* 2. Referral Dashboard Widget (Horizontal) */}
            {!siteInfo && (
              <div className="fintech-promo-card animate-fade-in" style={{ position: 'relative', overflow: 'hidden', padding: '12px 16px', background: 'linear-gradient(135deg, var(--primary) 0%, var(--secondary, #8B5CF6) 100%)', color: 'white', cursor: 'pointer', borderRadius: '12px', boxShadow: '0 8px 24px -8px var(--primary-glow)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }} onClick={() => navigate('/referrals')}>
                ...
                {/* Left Side */}
                <div style={{ position: 'relative', zIndex: 1, flex: 1, paddingRight: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontWeight: '800', fontSize: '14px', marginBottom: '2px' }}>
                    <Users size={14} />
                    <span>Referral Center</span>
                  </div>
                  <p style={{ fontSize: '11px', opacity: 0.9, margin: 0, lineHeight: '1.2' }}>Invite friends and earn activation bonuses.</p>
                </div>
                ...
                <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ display: 'flex', gap: '12px' }}>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '9px', opacity: 0.8, textTransform: 'uppercase', fontWeight: 'bold' }}>Invited</div>
                      <div style={{ fontSize: '13px', fontWeight: '900' }}>{referralAnalytics?.totalReferrals || 0}</div>
                    </div>
                    <div style={{ width: '1px', background: 'rgba(255,255,255,0.2)' }}></div>
                    <div style={{ textAlign: 'right' }}>
                      <div style={{ fontSize: '9px', opacity: 0.8, textTransform: 'uppercase', fontWeight: 'bold' }}>Earned</div>
                      <div style={{ fontSize: '13px', fontWeight: '900' }}>₦{(referralAnalytics?.totalReferralIncome || 0).toLocaleString()}</div>
                    </div>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.2)', padding: '6px 12px', borderRadius: '6px', fontSize: '11px', fontWeight: 'bold', backdropFilter: 'blur(4px)' }}>
                    Open &rarr;
                  </div>
                </div>
              </div>
