  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Ogdams MTN Data Gifting Pricing', path: '/admin/ogdams-sme-pricing', icon: <CreditCard size={18} /> },
        { name: 'SmePlug MTN Data Gifting Pricing', path: '/admin/smeplug-gifting-pricing', icon: <CreditCard size={18} />, badge: 'NEW' },
