...
const replacement = `  const [showMoreMenu, setShowMoreMenu] = useState(false);
  ...
  return (
    <div className="fintech-dashboard-wrapper">
      ...
      <div className="fintech-content-area animate-fade-in">
        ...
        <header className="fintech-top-nav">
          ...
          <div className="nav-actions">
            <button className="icon-btn" onClick={() => fetchUserInfo()} title="Refresh Balance"><RefreshCcw size={16} /></button>
        ...
        <div className="slim-banners-container animate-fade-in">
          <div className="promo-banner promo-banner-website" onClick={() => {
              const url = \`https://\${user?.domain || '9jasub.com'}\`;
              window.open(url, '_blank');
            }}>
          ...
          <div className="promo-banner promo-banner-referral" onClick={() => navigate('/referrals')}>
            <div className="promo-banner-content">
              ...
              <p>Earn commissions whenever your referrals transact.</p>
            </div>
            <div className="promo-banner-action">
      ...
      {/* --- Modals / Overlays --- */}
      {selectedTx && (
        <div className="modal-overlay animate-fade-in" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(8px)', background: 'rgba(0,0,0,0.8)', position: 'fixed', top:0, left:0, right:0, bottom:0, zIndex: 3000 }}>
          <div className="fintech-tx-modal animate-scale-in" style={{ 
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '16px', borderRadius: '16px', fontSize: '13px', marginBottom: '24px', border: '1px solid rgba(255,255,255,0.05)' }}>
