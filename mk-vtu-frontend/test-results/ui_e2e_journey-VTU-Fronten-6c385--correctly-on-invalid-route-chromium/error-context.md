...
- Name: ui_e2e_journey.spec.js >> VTU Frontend E2E Journey >> Error pages render correctly on invalid route
- Location: tests\ui_e2e_journey.spec.js:73:3
...
Call log:
  - navigating to "http://localhost:4173/this-route-does-not-exist", waiting until "load"
