          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="flex-1 text-left">
                  <h2 className="text-lg font-bold text-slate-900 group-hover:text-emerald-700 mb-1">Personal Account</h2>
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="flex-1 text-left">
                  <h2 className="text-lg font-bold text-white mb-1">Own Your VTU Website & App</h2>
